 ...
 <section class="container">
  ...
  <div class="row">
    ...
    <div class="right-panel mb-4">
     <div class="card">
      <div class="card-header">
       ...
       <?php 
          $query  = "SELECT * FROM users WHERE unique_id='$receiver'";
          $result = $db->select($query);
          if($result){
          foreach($result as $active_user){ ?>
          <img src="../uploaded_img/<?php echo $active_user['img']; ?>"> 
          <?php 
   ...
   <div class="item col-xl-3">
     <h3>About</h3>
     <div class="cols">
        <center><img src="../uploaded_img/<?php echo $active_user['img']; ?>"> </center>
     </div>
     <div class="cols">
          <h5><?php echo $active_user['f_name']; ?> <?php echo $active_user['l_name']; ?></h5>
     </div>
     <div class="flex">
      <h2>Rating</h2>
      <div class="stars">
